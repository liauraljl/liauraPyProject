...
class SpiderMan(object):
    ...
    def doanloadtest(self):

        fileUrl='https://www.cs.toronto.edu/~kriz/cifar-10-python.tar.gz'
        filePath='E:\Test\pythonDownload\pp.tar.gz'
        fileUrl2='http://v2.mukewang.com/118bdec1-4c7a-41d0-831d-6e2e38cdcf49/L.mp4?auth_key=1561790641-0-0-9c6d8f185e448c7f84675b02ad137630'
        fileUrl3='http://v2.mukewang.com/118bdec1-4c7a-41d0-831d-6e2e38cdcf49/L.mp4'
        filePath2='E:\Test\pythonDownload\pp.mp4'
        urlretrieve(fileUrl3,filePath2,self.Schedule)
    ...
    def cmdshow_gbk(self):
        ...
        print(u"#####################################################################")
        try:
            ID = 615  # input(u'输入要下载的课程编号：'.encode('gbk'))
